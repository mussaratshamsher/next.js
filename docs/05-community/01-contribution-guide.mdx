...
I will suggest that with improved new features of images , images import link/path of file must also be imported directly or should give intellisence to choose image file path as components path are imported directly when they are passed in pages.. This feature will greatly reduce the time of developer as well as it will make ease of writing complex structure of writing path.
